...
namespace Progetto.App.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.TelegramUsername != user.TelegramUsername)
            {
                user.TelegramUsername = Input.TelegramUsername;
                var setTelegramUserResult = await _userManager.UpdateAsync(user);
