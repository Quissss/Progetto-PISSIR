...
namespace Progetto.App.Core.Migrations
{
    ...
    [Migration("20240719000903_AddCurrentChargeProperty")]
    partial class AddCurrentChargeProperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.ChargeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("EndChargingTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 19, 2, 9, 0, 696, DateTimeKind.Local).AddTicks(3372));
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 7, 19, 2, 9, 0, 696, DateTimeKind.Local).AddTicks(2839));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.CurrentlyCharging", b =>
                {
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 19, 2, 9, 0, 697, DateTimeKind.Local).AddTicks(2831));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.MwBot", b =>
                {
                    b.HasOne("Progetto.App.Core.Models.Parking", "Parking")
                        .WithOne()
                        .HasForeignKey("Progetto.App.Core.Models.MwBot", "ParkingId");
