...
namespace Progetto.App.Core.Migrations
{
    ...
    [Migration("20240726113320_AddPaymentHistory")]
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.ChargeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("EndChargingTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 26, 13, 33, 18, 284, DateTimeKind.Local).AddTicks(728));
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 7, 26, 13, 33, 18, 284, DateTimeKind.Local).AddTicks(110));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.CurrentlyCharging", b =>
                {
                    ...
                    b.Property<DateTime?>("StartChargingTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 26, 13, 33, 18, 285, DateTimeKind.Local).AddTicks(8888));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.PaymentHistory", b =>
                {
                    ...
                    b.Property<DateTime>("StartTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 26, 13, 33, 18, 289, DateTimeKind.Local).AddTicks(5270));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.Stopover", b =>
                {
                    ...
                    b.Property<DateTime?>("StartStopoverTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 26, 13, 33, 18, 291, DateTimeKind.Local).AddTicks(2209));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.StopoverHistory", b =>
                {
                    ...
                    b.Property<DateTime>("StartStopoverTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 26, 13, 33, 18, 292, DateTimeKind.Local).AddTicks(1864));
