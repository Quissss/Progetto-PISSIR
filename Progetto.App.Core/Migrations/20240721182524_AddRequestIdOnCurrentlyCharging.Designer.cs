...
namespace Progetto.App.Core.Migrations
{
    ...
    [Migration("20240721182524_AddRequestIdOnCurrentlyCharging")]
    partial class AddRequestIdOnCurrentlyCharging
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.ChargeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("EndChargingTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 21, 20, 25, 22, 465, DateTimeKind.Local).AddTicks(7284));
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 20, 25, 22, 465, DateTimeKind.Local).AddTicks(6568));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.CurrentlyCharging", b =>
                {
                    ...
                    b.Property<DateTime?>("StartChargingTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 20, 25, 22, 467, DateTimeKind.Local).AddTicks(3801));
