...
namespace Progetto.App.Core.Migrations
{
    ...
    [Migration("20240725001054_StopoverNameFix")]
    partial class StopoverNameFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.ChargeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("EndChargingTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 25, 2, 10, 53, 21, DateTimeKind.Local).AddTicks(3462));
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 7, 25, 2, 10, 53, 21, DateTimeKind.Local).AddTicks(2909));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.CurrentlyCharging", b =>
                {
                    ...
                    b.Property<DateTime?>("StartChargingTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 25, 2, 10, 53, 22, DateTimeKind.Local).AddTicks(3719));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.Stopover", b =>
                {
                    ...
                    b.Property<DateTime?>("StartStopoverTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 25, 2, 10, 53, 25, DateTimeKind.Local).AddTicks(8635));
