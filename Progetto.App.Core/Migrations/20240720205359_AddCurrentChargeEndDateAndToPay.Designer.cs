...
namespace Progetto.App.Core.Migrations
{
    ...
    [Migration("20240720205359_AddCurrentChargeEndDateAndToPay")]
    partial class AddCurrentChargeEndDateAndToPay
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.ChargeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("EndChargingTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 20, 22, 53, 56, 634, DateTimeKind.Local).AddTicks(7541));
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 7, 20, 22, 53, 56, 634, DateTimeKind.Local).AddTicks(6993));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.CurrentlyCharging", b =>
                {
                    ...
                    b.Property<DateTime?>("StartChargingTime")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 20, 22, 53, 56, 635, DateTimeKind.Local).AddTicks(7372));
