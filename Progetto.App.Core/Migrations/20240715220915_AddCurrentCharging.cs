...
{
    /// <inheritdoc />
    public partial class AddCurrentCharging : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValue: new DateTime(2024, 7, 16, 0, 9, 13, 118, DateTimeKind.Local).AddTicks(8662)),
