...
namespace Progetto.App.Core.Migrations
{
    ...
    [Migration("20240719003358_dbwbotfix")]
    partial class dbwbotfix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.ChargeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("EndChargingTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 19, 2, 33, 58, 174, DateTimeKind.Local).AddTicks(3947));
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 7, 19, 2, 33, 58, 174, DateTimeKind.Local).AddTicks(3493));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.CurrentlyCharging", b =>
                {
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 19, 2, 33, 58, 175, DateTimeKind.Local).AddTicks(2325));
