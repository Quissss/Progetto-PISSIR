...
namespace Progetto.App.Core.Migrations
{
    ...
    [Migration("20240720150512_FixMwBot")]
    partial class FixMwBot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.ChargeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("EndChargingTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 20, 17, 5, 12, 226, DateTimeKind.Local).AddTicks(3579));
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 7, 20, 17, 5, 12, 226, DateTimeKind.Local).AddTicks(3046));
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.CurrentlyCharging", b =>
                {
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 20, 17, 5, 12, 227, DateTimeKind.Local).AddTicks(4998));
