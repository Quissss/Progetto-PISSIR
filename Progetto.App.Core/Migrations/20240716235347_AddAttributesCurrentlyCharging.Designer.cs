...
namespace Progetto.App.Core.Migrations
{
    ...
    [Migration("20240716235347_AddAttributesCurrentlyCharging")]
    partial class AddAttributesCurrentlyCharging
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Progetto.App.Core.Models.CurrentlyCharging", b =>
                {
                    ...
                    b.Property<DateTime>("StartChargingTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 17, 1, 53, 44, 877, DateTimeKind.Local).AddTicks(3025));
