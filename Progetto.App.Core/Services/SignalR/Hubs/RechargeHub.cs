...
/// <summary>
/// SignalR hub for managing connections to the recharge service.
/// </summary>
public class RechargeHub : Hub
{
    private readonly ILogger<RechargeHub> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="RechargeHub"/> class with the specified logger.
    /// </summary>
    /// <param name="logger">The logger used to log connection events.</param>
    public RechargeHub(ILogger<RechargeHub> logger)
    {
        _logger = logger;
    }
