...
/// <summary>
/// SignalR hub for managing client connections related to MwBot services.
/// </summary>
public class MwBotHub : Hub
{
    private readonly ILogger<MwBotHub> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="MwBotHub"/> class with a logger instance.
    /// </summary>
    /// <param name="logger">Logger instance for logging connection events.</param>
    public MwBotHub(ILogger<MwBotHub> logger)
    {
        _logger = logger;
    }
